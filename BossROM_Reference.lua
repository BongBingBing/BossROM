...
cogsItem = "numismatics:cog" -- Item ID for the cogs
lastSummonTime = {}
summonCount = {}
...
local function displayMenu(username)
    term.clear()
                ...
                while os.time() - sessionStartTime < sessionTime do
                    if isAdmin then
                        ...
                        elseif response == "logout" then
                            break
                        elseif response == "terminate" or response == "Terminate" then
                            terminateProgram()
                        end

                    end
                    local bossName = displayMenu(username)
                    if bossName then
